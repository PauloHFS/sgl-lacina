export const BANCOS = [
  ...
  { value: '756', label: 'Bancoob (Sicoob)' },
  { value: '748', label: 'Sicredi' },
  { value: '077', label: 'Banco Inter' },
  { value: '260', label: 'Nubank' },
  { value: '290', label: 'PagSeguro' },
  { value: '380', label: 'PicPay' },
  { value: '136', label: 'Unicred' },
  { value: '323', label: 'Mercado Pago' },
  { value: '341', label: 'Iti (Itaú)' },
  { value: '197', label: 'Stone Pagamentos' },
  { value: '102', label: 'XP Investimentos' },
  { value: '129', label: 'UBS Brasil' },
];
...
// DICIONACIO DE ESTADO PARA A ARRAY DE CIDADES
