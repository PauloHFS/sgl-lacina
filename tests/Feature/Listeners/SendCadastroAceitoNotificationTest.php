...
describe('SendCadastroAceitoNotification Listener', function () {
    ...
    it('should be queued', function () {
        ...
        // Registra o listener manualmente para o teste
        Event::listen(CadastroAceito::class, SendCadastroAceitoNotification::class);

        Event::dispatch(new CadastroAceito($this->user));

        Event::assertDispatched(CadastroAceito::class);
    });
